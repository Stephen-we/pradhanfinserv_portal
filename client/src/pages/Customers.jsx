...
export default function Customers(){
  ...
  // Sample data for dropdowns (replace with actual data from your API)
        ...
        <DataTable
          columns={[
            ...
            { 
              ...
              cell: (value, row) => isAdmin ? (
                <select 
                  value={value || ""} 
                  onChange={(e) => updateCustomerField(row._id, "channelPartner", e.target.value)}
                  className="input"
                >
            ...
            { 
              ...
              cell: (value, row) => isAdmin ? (
                <select 
                  value={value || ""} 
                  onChange={(e) => updateCustomerField(row._id, "bankName", e.target.value)}
                  className="input"
                >
            ...
            { 
              ...
              cell: (value, row) => isAdmin ? (
                <select 
                  value={value || "open"} 
                  onChange={(e) => updateCustomerField(row._id, "status", e.target.value)}
                  className="input"
                >
